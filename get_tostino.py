...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        # FUNCTION BUTTON
        self.pizza_roll_button = Button(self, text = "TOTINOS!", command = self.output_pizza_roll)
    ...
    def output_pizza_roll(self):
        if self.text_entry.get() == '':
            ...
            self.pizzarolls = converter(int(self.text_entry.get()), self.currency.get())
        if self.pizzarolls <= 1:
            self.final_text = "You can buy " + str(self.pizzarolls) + " pizza roll with your money."
        else:
            self.final_text = "You can buy " + str(self.pizzarolls) + " pizza rolls with your money."

        self.results_txt.delete(0.0, END)
        self.results_txt.insert(0.0, self.final_text)
        # print(self.price_per_roll)

# main
root = Tk()
root.title("Pizza Roll Converter")
